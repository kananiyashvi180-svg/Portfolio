                ...
                <div className="flex flex-col lg:flex-row min-h-[500px] relative z-10">
                    ...
                    <div className="w-full lg:w-2/5 p-8 sm:p-12 md:p-16 flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-4 mt-auto">
                            <a href={item.live} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-black text-xs uppercase tracking-widest shadow-[0_10px_30px_rgba(0,243,255,0.3)] hover:scale-105 transition-all">
                                <ExternalLink size={16} /> Live Demo
                            </a>
                            <a href={item.github} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-8 py-4 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/10 text-white font-black text-xs uppercase tracking-widest backdrop-blur-md transition-all">
                                <Github size={16} /> Source Code
                            </a>
                        </div>
                    </div>

                    {/* Right side: Modern Project Mockup (The Screenshot you provided) */}
                    <div className="w-full lg:w-3/5 relative min-h-[300px] lg:min-h-[500px] flex items-center justify-center p-6 lg:p-12 overflow-hidden bg-transparent">
                        <div className="relative w-full max-w-[700px] group/mockup">
                            {/* Browser/Window Frame */}
                            <div className="relative rounded-2xl overflow-hidden border border-white/20 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.7)] transform-gpu rotate-1 group-hover/mockup:rotate-0 transition-all duration-700">
                            ...
                            {/* Floating decorative cards or effects */}
                            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-purple-500/20 rounded-full blur-[80px] pointer-events-none animate-pulse" />
                            <div className="absolute -top-10 -right-10 w-40 h-40 bg-cyan-500/20 rounded-full blur-[80px] pointer-events-none animate-pulse" />
                        </div>
                    </div>
                </div>
            </motion.div>
        ...
        >
            ...
            <div className="absolute inset-0 z-20 p-6 sm:p-8 flex flex-col justify-between pointer-events-none">
                ...
                <div>
                    ...
                    <p className="text-cyan-400 font-black text-[10px] uppercase tracking-[0.2em] drop-shadow-md flex items-center gap-2 opacity-0 -translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-150 mb-3">
                        Click to view details <span className="w-12 h-px bg-cyan-400/50 block"></span>
                    </p>
                    {/* Quick-access links on card */}
                    {(type === 'project' || type === 'clone') && (
                        <div className="flex gap-2 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 pointer-events-auto">
                            {item.live && (
                                <a
                                    href={item.live}
                                    target="_blank"
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-cyan-500/90 hover:bg-cyan-400 text-white text-[10px] font-black uppercase tracking-widest shadow-[0_0_12px_rgba(0,243,255,0.4)] transition-all duration-150"
                                >
                            ...
                            {item.github && (
                                <a
                                    ...
                                    rel="noreferrer"
                                    onClick={e => e.stopPropagation()}
                                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white text-[10px] font-black uppercase tracking-widest backdrop-blur-md transition-all duration-150"
                                >
